       ...
       <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
        <div class="team-item">
            <div class="d-flex">
                ...
                <img class="img-fluid rounded w-75" src="./img/hilmy.jpeg" alt="" style="height: 300px; object-fit: cover;">
            </div>
            <div class="px-4 py-3">
                <h5 class="fw-bold m-0">Ahmad Hilmy</h5>
                <small>0110223148</small>
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="team-item">
            <div class="d-flex">
                ...
                <img class="img-fluid rounded w-75" src="./img/nazwa.jpeg" alt="" style="height: 300px; object-fit: cover;">
            </div>
            <div class="px-4 py-3">
    ...
    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.9s">
        <div class="team-item">
            <div class="d-flex">
                ...
                <img class="img-fluid rounded w-75" src="./img/apiz.jpeg" alt="" style="height: 300px; object-fit: cover;">
            </div>
            <div class="px-4 py-3">
    ...
    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="1.2s">
        <div class="team-item">
            <div class="d-flex">
                ...
                <img class="img-fluid rounded w-75" src="./img/siti.jpeg" alt="" style="height: 300px; object-fit: cover;">
            </div>
            <div class="px-4 py-3">
